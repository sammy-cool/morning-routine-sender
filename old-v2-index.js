...
app.use(
  "/assets",
  express.static(path.join(__dirname, "src/web/public/assets"), {
...
app.get("/manifest.json", (req, res) => {
  res.sendFile(path.join(__dirname, "src/web/public", "manifest.json"));
});

app.get("/sw.js", (req, res) => {
  res.sendFile(path.join(__dirname, "src/web/public", "sw.js"));
});
