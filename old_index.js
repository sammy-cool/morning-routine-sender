...
const {
  ...
  cleanupOldEntries,
  updateTracker,
} = require("./email-core/emailTracker");
...
app.get("/health-check", (req, res) => {
  updateTracker("health-check", "success", "Health check successful");
...
async function gracefulShutdown(signal) {
  ...
  try {
    // Stop accepting new jobs (if using scheduler)
    // scheduler.stop();
