...
router.get("/admin/subscribers/stats", requireAdmin, subscriberStatsController.getSubscriberStats);
...
router.patch("/admin/subscribers/:email", requireAdmin, subscribersController.updateSubscriber);
router.delete("/admin/subscribers/:email", requireAdmin, subscribersController.deleteSubscriber);
