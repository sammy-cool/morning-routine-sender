...
router.post("/routine/checkin", routineController.checkin);
...
router.get("/me/radar.svg", resolveSessionOrToken, meController.getRadarChart);
router.get("/me/radar", resolveSessionOrToken, meController.getRadarChart);
